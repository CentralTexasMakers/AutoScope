...
//RN: X retainer (lower/smaller) -- shaft 26.25 mm
//RN: Y retainer (upper/larger) -- shaft 29.5 mm

// tuneable constants


motor_shaft = 26.50;	// NEMA17 motor shaft exact diameter = 5

//teeth not used for retainer
teeth = 60;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
//profile not used for retainer
...
pulley_t_ht = 0;	// length of toothed part of pulley, standard = 12
